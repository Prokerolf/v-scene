        ...
        <div className="flex flex-col gap-3 px-4 flex-grow overflow-y-auto pb-6">
          ...
          <div className="mt-auto bg-surface-container p-4 rounded-xl border border-outline-variant shadow-2xs">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="font-label-sm font-bold text-primary">{uniqueCasesCompleted}/{availableCases.length} เคส</span>
            </div>
            <div className="w-full bg-outline-variant/60 rounded-full h-3 overflow-hidden p-0.5 mb-1">
